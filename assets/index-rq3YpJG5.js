...
void main() {
  ...
  `;oa([wl({type:String,attribute:"auto-dark",reflect:!0})],Fr.prototype,"autoDark",2);oa([wl({type:Number,attribute:"shape-color"})],Fr.prototype,"shapeColor",2);oa([wl({type:Number,attribute:"selected-shape-color"})],Fr.prototype,"selectedShapeColor",2);Fr=oa([dp("shape-puzzle-captcha")],Fr);
