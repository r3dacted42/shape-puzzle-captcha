...
#define LOW_PRECISION`),t}const $x={[Oo]:"SHADOWMAP_TYPE_PCF",[ds]:"SHADOWMAP_TYPE_VSM"};function qx(i){return $x[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const Yx={[$i]:"ENVMAP_TYPE_CUBE",[Br]:"ENVMAP_TYPE_CUBE",[oa]:"ENVMAP_TYPE_CUBE_UV"};function Zx(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":Yx[i.envMapMode]||"ENVMAP_TYPE_CUBE"}const Kx={[Br]:"ENVMAP_MODE_REFRACTION"};function Jx(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":Kx[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}const jx={[Qf]:"ENVMAP_BLENDING_MULTIPLY",[sg]:"ENVMAP_BLENDING_MIX",[og]:"ENVMAP_BLENDING_ADD"};function Qx(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":jx[i.combine]||"ENVMAP_BLENDING_NONE"}function ty(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:n,maxMip:e}}function ey(i,t,e,n){const r=i.getContext(),s=e.defines;let o=e.vertexShader,a=e.fragmentShader;const l=qx(e),h=Zx(e),f=Jx(e),g=Qx(e),p=ty(e),m=Bx(e),v=zx(s),A=r.createProgram();let _,x,E=e.glslVersion?"#version "+e.glslVersion+`
...
`].filter(gs).join(`
`)),o=xl(o),o=Eh(o,e),o=bh(o,e),a=xl(a),a=Eh(a,e),a=bh(a,e),o=Ah(o),a=Ah(a),e.isRawShaderMaterial!==!0&&(E=`#version 300 es
...
`)+`
`+x);const d=E+_+o,c=E+x+a,S=yh(r,r.VERTEX_SHADER,d),u=yh(r,r.FRAGMENT_SHADER,c);r.attachShader(A,S),r.attachShader(A,u),e.index0AttributeName!==void 0?r.bindAttribLocation(A,0,e.index0AttributeName):e.morphTargets===!0&&r.bindAttribLocation(A,0,"position"),r.linkProgram(A);function R(b){if(i.debug.checkShaderErrors){const w=r.getProgramInfoLog(A)||"",C=r.getShaderInfoLog(S)||"",U=r.getShaderInfoLog(u)||"",F=w.trim(),B=C.trim(),O=U.trim();let k=!0,G=!0;if(r.getProgramParameter(A,r.LINK_STATUS)===!1)if(k=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,A,S,u);else{const at=Mh(r,S,"vertex"),et=Mh(r,u,"fragment");Jt("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(A,r.VALIDATE_STATUS)+`
