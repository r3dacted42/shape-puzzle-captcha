...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Yn,depthTest:!1,depthWrite:!1})}function wv(i,t,e){const n=new Float32Array(Bi),r=new D(0,1,0);return new Dn({name:"SphericalGaussianBlur",defines:{n:Bi,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/e,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:aa(),fragmentShader:`
		...
		`,blending:Yn,depthTest:!1,depthWrite:!1})}function fu(){return new Dn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:aa(),fragmentShader:`
		...
		`,blending:Yn,depthTest:!1,depthWrite:!1})}function du(){return new Dn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:aa(),fragmentShader:`
...
void main() {
  ...
  `;qr([yi({type:String,attribute:"event-key",reflect:!0})],xi.prototype,"eventKey",2);qr([yi({type:Boolean,attribute:"disable-audio-btn",reflect:!0})],xi.prototype,"disableAudioBtn",2);qr([yi({attribute:"auto-dark",reflect:!0,converter:i=>i==="data"?"data":i!==null&&i!=="false"})],xi.prototype,"autoDark",2);qr([yi({type:Number,attribute:"shape-color",reflect:!0})],xi.prototype,"shapeColor",2);qr([yi({type:Number,attribute:"selected-shape-color",reflect:!0})],xi.prototype,"selectedShapeColor",2);xi=qr([Zf("shape-puzzle-captcha")],xi);
