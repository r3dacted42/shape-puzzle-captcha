	...
	if ( coord.x >= 1.0 ) {
      ...
      <footer>
        ...
        <button
          ...
          .innerHTML="${UM}"
        ></button>
        <button class="icon-btn" id="info-btn" .innerHTML="${LM}"></button>
